...
export default function EcommerceInvoice() {
  ...
  return (
    <Page title="Ecommerce: Invoice | CoachMatic">
        ...
        <Card sx={{ pt: 5, px: 5 }}>
          <Grid container>
            <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
              <Box component="img" alt="logo" src="/static/brand/logo_full.png" sx={{ height: 48 }} />
            </Grid>
          ...
          <Grid container>
            ...
            <Grid item xs={12} md={3} sx={{ py: 3, textAlign: 'right' }}>
              ...
              <Typography variant="body2">support@coachmatic.com</Typography>
            </Grid>
          </Grid>
        </Card>
      </Container>
